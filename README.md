...
- **Clear battery percentage** — See your remaining battery charge more prominently.
- **Charging status** — Quickly see whether your Mac is currently charging.
- **Menu bar utility** — Designed to sit quietly in the menu bar and stay out of your way.
- **Lightweight** — Uses minimal system resources.
- **Simple** — No account, subscription or complicated configuration.
- **At-a-glance information** — Quickly check your battery without opening System Settings.
...
Try opening PowerPeek normally.
Open System Settings.
Select Privacy & Security.
Scroll down to the Security section.
You may see a message stating that PowerPeek was blocked.
Click Open Anyway.
Confirm that you want to open PowerPeek.
